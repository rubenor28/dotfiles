...
keymap.set("n", "<leader>fs", "<cmd>Telescope live_grep<cr>", { desc = "Buscar una cadena en el directorio actual" })
keymap.set("n", "<leader>fc", "<cmd>Telescope grep_string<cr>", { desc = "Buscar la cadena bajo el cursor en el directorio actual" })
