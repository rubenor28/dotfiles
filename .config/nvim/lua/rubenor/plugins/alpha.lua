return {
  ...
  config = function()
    ...
    dashboard.section.buttons.val = {
      ...
      dashboard.button("SPC ee", "  > Abrir/Cerrar explorador de archivos", "<cmd>NvimTreeToggle<CR>"),
      ...
      dashboard.button("SPC wr", "󰁯  > Restaurar sesión en dir actual", "<cmd>SessionRestore<CR>"),
