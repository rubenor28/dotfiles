...
set -euo pipefail
echo "============================================================"
echo "[Script] Instalando apps, y utilidades"
echo "============================================================"
if ! zypper repos | grep "brave-browser"; then
...
flatpak install flathub app.twintaillauncher.ttl
...
sudo zypper refresh
sudo zypper install dotnet-sdk-10.0 aspnetcore-runtime-10.0

RPMS_PATH="$HOME/packages/rpms"
mkdir -p "$RPMS_PATH"
wget https://dbeaver.io/files/dbeaver-ce-latest-linux-x86_64.rpm -O "$RPMS_PATH/dbeaver-ce.rpm"
wget https://github.com/Heroic-Games-Launcher/HeroicGamesLauncher/releases/download/v2.22.1/Heroic-2.22.1-linux-x86_64.rpm -O "$RPMS_PATH/heroic-games-launcher.rpm"
wget https://github.com/codelerity/netbeans-packages/releases/download/v31-build1/apache-netbeans-31-0.x86_64.rpm -O "$RPMS_PATH/netbeans.rpm"

sudo zypper in "$RPMS_PATH/*.rpm"
